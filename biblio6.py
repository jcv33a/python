...
def main():
    ...
    libro_menu = tk.Menu(menubar, tearoff=0)
    menubar.add_cascade(label="Opciones", menu=libro_menu)
    libro_menu.add_command(label="Agregar Libro", command=agregar_libro)
    libro_menu.add_command(label="Prestar Libro", command=prestar_libro)
    libro_menu.add_command(label="Devolver Libro", command=devolver_libro)
    libro_menu.add_command(label="Mostrar Libros", command=mostrar_libros)
    libro_menu.add_command(label="Eliminar Libro", command=eliminar_libro)
    libro_menu.add_separator()
    libro_menu.add_command(label="Salir", command=root.destroy)
