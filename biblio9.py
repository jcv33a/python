...
def main():
    ...
    titulo_label = ttk.Label(menu_frame, text="Menú Biblioteca")
    titulo_label.grid(row=0, column=0, columnspan=6, pady=5)

    ttk.Button(menu_frame, text="Agregar Libro", command=agregar_libro).grid(row=1, column=0, padx=5, pady=5)
    ttk.Button(menu_frame, text="Prestar Libro", command=prestar_libro).grid(row=1, column=1, padx=5, pady=5)
    ttk.Button(menu_frame, text="Devolver Libro", command=devolver_libro).grid(row=1, column=2, padx=5, pady=5)
    ttk.Button(menu_frame, text="Mostrar Libros", command=mostrar_libros).grid(row=1, column=3, padx=5, pady=5)
    ttk.Button(menu_frame, text="Eliminar Libro", command=eliminar_libro).grid(row=1, column=4, padx=5, pady=5)
    ttk.Button(menu_frame, text="Salir", command=root.destroy).grid(row=1, column=5, padx=5, pady=5)
